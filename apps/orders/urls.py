...
urlpatterns = [
    ...
    path('cart/promo-code/apply/', views.CartPromoCodeApplyView.as_view(), name='cart-promo-code-apply'),
    path('cart/promo-code/', views.CartPromoCodeView.as_view(), name='cart-promo-code'),
